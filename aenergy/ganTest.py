...
#Generator
    ...
    def sample(self, N):
        ...
        return np.linspace(-self.range, self.range, N) + \
            ...
            #why using two different numpy methods to pick random samples??
            #wtf that backslash

def linear(input, output_dim, scope=None, stddev=1.0):
    with tf.variable_scope(scope or 'linear'):
        #are we creating the variable here or just grabbing it?
